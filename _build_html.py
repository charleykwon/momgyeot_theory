...
<style>
  body { font-family: 'Apple SD Gothic Neo', system-ui, sans-serif;
         ...
         min-height: 100vh; margin: 0; background: #faf6f0; color: #2c2826; }
  a { color: #8c6e4e; text-decoration: none; border-bottom: 1px dotted #8c6e4e; }
</style>
</head>
<body>
...
.chapter-body mark.pen-yellow {
  background: linear-gradient(180deg,
    ...
    rgba(245, 211, 100, 0.5) 55%, rgba(245, 211, 100, 0.5) 92%,
    transparent 92%);
}
.chapter-body mark.pen-peach {
  background: linear-gradient(180deg,
    transparent 0%, transparent 55%,
    rgba(244, 178, 154, 0.45) 55%, rgba(244, 178, 154, 0.45) 92%,
    transparent 92%);
}
.chapter-body mark.pen-sage {
  background: linear-gradient(180deg,
    transparent 0%, transparent 55%,
    rgba(167, 198, 169, 0.45) 55%, rgba(167, 198, 169, 0.45) 92%,
    transparent 92%);
}
@media print {
...
.toc-item { border-bottom: 1px solid #f0eadd; }
...
.toc-expand {
  background: none; border: none; border-left: 1px solid #f0eadd;
...
@media print {
  #menu-toggle, #drawer, #drawer-backdrop, #back-to-top, #resume-toast { display: none !important; }
}
...
.infographic-cards .card.modern { background: #fff; }
