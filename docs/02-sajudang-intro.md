...
- "조선의 한 여성 학자" 섹션을 *학자로서의 사주당 이씨*가 충분히 드러나도록 풀스펙으로 재집필했다. 호의 의미(희현당 → 사주당), 바늘을 던진 학문 입문 일화, 30년의 부부 학문 토론(주자 견해에 반대한 일 포함), 동시대 학자들의 인정, 가족 학문 네트워크(아들 유희·외조카뻘 빙허각 이씨), 신사임당과의 다른 자리, 그리고 생애 연표 표를 모두 담았다. 단정·영웅화 어휘는 회피하고, 5개의 새 각주(–)로 1차 자료 보강 포인트를 명시했다.
...
[^1]: 한국민족문화대백과사전, 「태교신기(胎敎新記)」 항목 — 『태교신기』는 사주당 이씨가 1800년(정조 24)에 한문으로 저술을 마친 뒤, 이듬해인 1801년(순조 1)에 아들 유희(柳僖)가 한글 음과 토, 주석을 더해 『태교신기언해』를 완성한 임산부 태교법 교습서이다. 태교의 원리와 방법을 체계적으로 정리한, 조선에서 간행된 최초의 태교 전문서로 널리 평가된다.
[^2]: 사주당 이씨, 『태교신기』 — 가족 전체의 역할. 해당 취지는 제1장 「부태교(敷胎敎)」 및 제8장 「부태중금기(附胎中忌)/열성제절(列聖諸節)」 등에서 강조된다. 특히 *"태교는 임신부 한 사람의 일에 그치는 것이 아니라, 온 집안 사람이 함께 힘써야 한다"*는 대목은 제8장에 구체적으로 명시되어 있다. 인용 판본: 『태교신기』 (박숙희 역, 서울대학교출판문화원, 2013) — 또는 정양완 역, 을유문화사 판본 참고.
[^3]: 임신기 정서 및 모-태아 애착 관련 학술 문헌 — 국내 간호학계의 대표적 연구로 다음 두 편을 참고한다. 1) Kwon, Mi-Kyung & Bang, Kyung-Sook, 「임신 중 스트레스, 우울과 모-태아 애착 및 태아체중의 상관관계」, 『대한간호학회지(Journal of Korean Academy of Nursing)』 41권 2호, 2011, 276–283쪽 — 임부 166명을 대상으로 스트레스와 우울, 모-태아 애착, 태아체중의 관계를 분석한 결과, 임신 중 스트레스는 모-태아 애착 및 태아체중과 통계적으로 유의한 상관을 보이지 않았으나, 우울은 모-태아 애착에 부정적 영향을 미칠 위험요인으로 논의함. 2) 「임부의 불안, 우울, 산전스트레스와 모-태아 애착 및 감사성향의 관계」, 『모자보건학회지(Journal of Maternal and Child Health)』 — 임부의 불안·우울·산전 스트레스가 높을수록 모-태아 애착과 감사성향 점수가 낮아지는 음의 상관을 보고함으로써, 산전 정서가 애착 형성의 중요한 위험·보호 요인임을 시사함.
[^4]: 노중례, 『태산요록(胎産要錄)』, 1434(세종 16년) — 조선 세종 대에 판전의감사 노중례가 왕명을 받아 편찬한 임신·출산 및 영유아 질병 치료에 관한 전문 의서로, 태산과 소아 의학에서 조선 전기 의학의 독자적 발전을 보여 주는 중요한 자료로 평가된다. 상권 「태산문(胎産文)」에 포함된 *양태근신법(養胎謹愼法)*은 태교론·식기론 등과 함께 임신 중 섭생과 피해야 할 일을 항목별로 정리하고 있어, 임신기 생활 관리와 금기에 관한 초기 체계적 서술로 의미가 크다. 해제·영인본으로는 국립중앙도서관 및 가천박물관 소장 보물 제1179호 목판본을 저본으로 한 영인본과, 『한국의학대계』 수록 판본 등을 참고한다.
[^5]: 허준, 『언해태산집요(諺解胎産集要)』, 1608(선조 41년) — 선조의 명으로 어의 허준이 1434년 노중례의 『태산요록』을 개편·언해하여, 임신과 출산 및 유아 보호에 관한 증상과 처방을 한글로 풀이해 내의원에서 훈련도감자로 간행한 산부인과 계통의 의학서이다. 『동의보감』 「부인문」에서 다루는 임신·출산·산후 관리와 상당 부분 의학적 맥락을 공유하는 것으로 평가되며, 조선 후기 여성·산과 의료의 실상을 보여 주는 자료로 활용된다. 해제·판본 정보는 국립중앙도서관 소장본(보물 제1088-1호)의 해제와, 한국학중앙연구원 장서각·Encyves DB에 수록된 서지·해제를 참고한다.
[^6]: 산실청(産室廳)·호산청(護産廳)의 제도화 — 『조선왕조실록』에서는 1603년(선조 36) 인목왕후의 출산을 준비하는 과정에서 *산실청*이라는 명칭이 처음 등장하며, 이를 왕비의 산실을 담당하는 관서로 규정하는 논의가 이루어진다(『선조실록』 선조 36년 기사). 산실청은 왕비와 왕세자빈의 출산을 위해 내의원 안에 임시로 설치되는 기구로, 출산 예정일 약 3개월 전에 조직되며, 출산 준비와 산실 의례 전반을 관장하였다. 호산청은 후궁의 임신 사실이 의관 진찰로 확인되면 출산 예정일 1개월 전에 내의원 안에 임시로 설치되어 후궁의 출산과 출산 직후 7일간의 의례를 담당하는 관서로, 산실청과는 설치 시기와 관원 구성에서 구별되었다(『육전조례』 예전 내의원 산실청·호산청 조항 참조).
[^7]: 『임산예지법(臨産豫知法)』, 조선 후기 — 왕실의 임신한 여인이 출산 전후에 미리 숙지해야 할 사항을 정리한 한글 위주의 필사본으로, 출산 전의 주의사항과 산실 환경, 해산 후 몸가짐, 태독 제거법, 탯줄 자르는 법, 젖 먹이는 법, 목욕법, 갓난아이 보호법 등 출산 전후 단계별 실무 지침을 담고 있다. 한국학중앙연구원 장서각에 고문서로 소장되어 있으며(청구기호 K2-861, RD00861), 궁중의 출산 문화를 가장 자세히 보여 주는 왕실 출산 지침서이자 현재까지 알려진 유일한 왕실 출산 지침 자료로 평가되어 사료적 가치가 매우 높다.
[^8]: 사주당 이씨의 호 변경 근거 — 결혼 초기에는 *어진 이를 본받기를 바란다*는 뜻의 희현당(希賢堂)을 당호로 사용했으나, 이후 성리학 공부에 몰두하면서 성리학의 대가 주희(朱熹)를 스승으로 삼겠다는 뜻을 담아 사주당(師朱堂)으로 고친 것으로 전해진다. 희현당에서 사주당으로의 호 변경 사실은 아들 유희가 지은 「선비사주당이씨행장(先妣師朱堂李氏行狀)」과 관련 연구에서 반복적으로 인용되며, 정확한 표기와 서술 맥락은 출간 전 행장 원문 대조를 통해 보강한다.
[^9]: 학문 입문 일화 — 어린 시절 바느질과 길쌈을 잘해 이름이 났으나, 어느 날 바늘을 던지며 *"사람이 사람 노릇 하는 것이 어찌 여기에 있겠는가(人爲人 在茲乎)"*라고 탄식하고, 여자아이들의 통상적인 놀이나 가사 노동 대신 유교 경전 읽기에 몰두하기로 결심했다는 일화가 전해진다. 이 일화는 유희가 남긴 행장 등 1차 자료를 바탕으로 한 연구·해설에서 반복적으로 인용되며, 정확한 한문 원구와 출처 표기는 출간 전 「사주당이씨행장」 원문 대조를 통해 보강한다.
