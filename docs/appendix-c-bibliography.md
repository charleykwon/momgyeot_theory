...
본문에서 인용하거나 본 권의 작업 과정에서 산출된 맘곁·마더스베이비 헤리티지 자산입니다 (바비즈코리아).
...
**부록 C**는 본 권이 어떤 자료 위에 서 있는지를 밝히는 *발판*입니다.

본 권을 읽는 임신부와 가족이 부록을 어떻게 활용해도 좋습니다.
다만 한 가지 — *부록은 시험지가 아니라 자료편*이라는 점을 기억해 주시기 바랍니다.
다 외우거나 다 채울 필요가 없습니다.
필요할 때 펼쳐서, 한 줄을 만나고, 다시 일상으로 돌아가는 것 —
그것이 사주당 이씨가 200년 전 짧은 35절을 남긴 자리이기도 합니다.
