...
[^1]: 모성 스트레스의 생화학과 태아 환경 — 6장 [^3]과 동일 자료 계통(DOHaD: Barker 1995 *BMJ*; Gluckman & Hanson 2008 *NEJM*; Hanson & Gluckman 2014 *Physiological Reviews*; 모성 스트레스–태아 신경발달: Glover 2014 *J Child Psychol Psychiatry*). 본 장에서는 *지속되는 부담이 호르몬 환경에 미세한 결을 남길 수 있다*는 가능성 수준의 인용에 머문다. 부록 C-3·C-4 항목과 동일.
[^2]: 임신부 SNS·인터넷 정보 환경과 산전 정서의 관련성 — 국내·외 모성건강·디지털건강 분야의 임신부 미디어 사용 연구를 출발점으로, 본 장의 진술 범위(정보 환경의 결과 정서 흐름의 양적 관련 가능성)에 부합하는 1~2건으로 좁혀 표기. 본 장에서는 비율·시간 단정 없이 일반 흐름 진술에 머문다.
