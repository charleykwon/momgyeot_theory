...
[^1]: 임신 중 모체의 식습관과 향·맛 노출이 태아 및 출생 후 영아의 미각·후각 경험에 영향을 줄 수 있다는 산모-영아 영양·발달 연구 — 양수와 모유를 통한 향 노출에 관한 국제 연구 흐름(예: J. A. Mennella 계열 연구)과 국내 모성영양·간호학 학술지의 관련 연구 1~2건으로 좁혀 표기. 본 챕터의 진술 범위(영향 가능성의 시사, 인과 단정의 회피)에 부합하는 자료를 선택할 것.
[^2]: 임신 시기별 태아 발달의 일반적 흐름과 청각·촉각·시각 등 감각계의 자리 잡는 시기에 관한 학술적 합의 — 산부인과·태아 발달학 교과서 또는 국내 모성간호학 교재의 해당 단원, 또는 fetal development·fetal acoustics 분야의 종설을 1~2건 명시. 본 챕터에서는 시기별 도표(1·2·3분기), 청각계 발달 시기, 촉각의 조기 발달, 후기 빛 반응 모두에 동일 자료 계통을 사용한다. 특정 주차 단정은 피한다.
[^3]: 태아의 시각 발달과 임신 후기 빛 자극에 대한 반응 — Hepper PG 등의 fetal visual response 종설 흐름을 출발점으로, 본 장의 진술 범위(*강한 인과 회피, 일반적 관찰 수준*)에 부합하는 1~2건으로 좁혀 표기. 빛 자극이 태아 행동에 단정적 영향을 준다고 주장하는 자료는 채택하지 않는다.
