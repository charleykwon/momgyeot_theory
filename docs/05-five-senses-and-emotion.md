...
[^1]: 임부의 식습관과 영아의 미각·후각 경험 — 임신 중 산모가 섭취한 음식과 음료의 향미 성분은 양수를 통해 태아에게, 그리고 출생 후에는 모유를 통해 영아에게 전달될 수 있으며, 이러한 초기 향미 경험이 이유기 이후 특정 맛에 대한 수용성이나 선호도에 영향을 미칠 수 있다는 연구 결과가 보고되어 왔다. Mennella 등은 산모에게 특정 향미(예: 당근, 아니스 등)를 임신 말기와 수유기에 제공한 뒤 영아의 반응을 관찰한 연구에서, 산전·산후에 해당 향미에 노출된 영아가 이유기에 비슷한 풍미의 이유식을 더 잘 받아들이고 즐기는 경향을 보인다고 보고하여, 인간 영아에서 태내·초기 향미 학습이 식행동에 미치는 영향을 보여 준 대표적 연구로 평가된다. 국내 모성·지역사회 영양 관련 고찰에서는 임신·수유기 어머니의 식생활 패턴이 자녀의 식행동 형성과 음식 선호의 토대가 될 수 있다는 가능성을 제기하며, 구체적인 상관과 기전은 향후 연구 과제로 남겨 둔다.
[^2]: 임신 시기별 태아 발달과 감각계 형성의 일반적 흐름 — 태아의 감각계는 촉각이 가장 먼저 발달하여 임신 1삼분기 후반부터 입·얼굴·손바닥 주변에 대한 접촉 자극에 반응하기 시작하고, 이어 2삼분기 동안 미각·후각 계통이 성숙하여 양수 속 맛과 냄새 성분에 대한 반응과 학습이 가능해지며, 청각은 2삼분기 중반(대략 24주 전후)을 기점으로 저주파 음에 기능적으로 반응하기 시작해 3삼분기에 걸쳐 성숙하고, 시각은 마지막까지 발달이 늦어 임신 후기 강한 빛 자극에 대한 심박·움직임 반응이 관찰되는 수준에 이른다고 보고된다. 본 챕터의 시기별 도표와 발달 타임라인은 이러한 문헌들을 바탕으로 각 감각계의 발달을 특정 주차에 고정해 단정하기보다, 촉각–후각·미각–청각–시각 순으로 진행되는 일반적인 생물학적 발달 구간을 요약한 것으로 제시하였다.
[^3]: 태아의 시각 발달과 임신 후기 빛 반응 — 태아의 시각계는 감각 체계 가운데 가장 늦게 기능적으로 발달하며, 자궁 내 환경 특성상 자연 상태에서 경험하는 시각 자극은 매우 제한적이다. 일부 연구에서는 임신 후기(3삼분기)의 인간 태아에게 자궁벽을 통과할 만큼 강한 빛 자극을 제시했을 때 심박수 변화나 머리·눈의 움직임 등 반응이 나타난다고 보고하여, 이 시기에 최소한의 시각적 감지와 자극 구별 능력이 존재할 수 있음을 시사한다. 예를 들어 Reid 등은 강한 빛으로 투사한 얼굴 비슷한 패턴과 뒤집힌 패턴 사이에서 후기 태아가 얼굴 비슷한 패턴 쪽으로 머리를 더 자주 돌리는 양상을 관찰하여, 신생아와 유사한 수준의 단순한 얼굴자극 선호가 태내에서도 나타날 수 있다고 보고하였다. 그러나 이러한 시각 반응이 출생 후 시력 발달이나 인지 발달에 직접적인 인과적 이득을 준다고 보기는 아직 이르며, Hepper를 비롯한 종설들은 태내 시각 자극의 잠재적 역할을 탐색하는 단계에서 신중한 해석이 필요하다고 강조한다.
