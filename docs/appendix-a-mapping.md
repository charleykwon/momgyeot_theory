...
『태교신기』는 1800년(정조 24년) 사주당 이씨(師朱堂 李氏, 1739~1821)가 한문으로 짓고, 아들 유희(柳僖)가 1801년 한글로 풀어 음의를 단 책입니다 ([한국민족문화대백과사전](https://encykorea.aks.ac.kr/Article/E0058957)).
...
박물관 유물이 아니라 *오늘 임신부의 책상 위에서 펼쳐 읽을 수 있는 형태*로 옮긴 것입니다.
...
그 안의 절반이 *감각 환경과 신체 자기돌봄*을 다룹니다.
사주당이 가장 많은 분량을 들인 자리가
*추상적 도덕*이 아니라 *일상 환경*이라는 점은,
그가 태교를 관념이 아닌 *환경 설계*로 보았음을 보여줍니다.

또 하나 — 책의 첫 절(1-3)과 마지막 절(10-1)이 모두 *아버지의 책임*을 가리킨다는 사실입니다.
